...
export const GuidesMainPage = {
  ...
  fields: [
...

    {
      ...
      type: "blocks",
      blocks: [],
      blockReferences: ["resourcesHero", "featureGuide", "guidesBody", "pagination", "globalCTA", "globalClientLogotypes", "ctaForm", "cta", "clientLogotypes", "ctaSmall"]
    }
  ]
